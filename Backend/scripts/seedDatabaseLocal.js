// scripts/seedDatabaseLocal.js - Database Seeding Script for Local MongoDB
...
const seedDatabase = async () => {
    try {
        ...
        const localMongoURI = 'mongodb://localhost:27017/intellihealth';
        console.log(`📡 Connecting to local MongoDB: ${localMongoURI}`);
